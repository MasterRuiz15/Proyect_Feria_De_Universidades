...
<body>
    ...
    <!--Formulario de registro de un delegado-->
    <form action="Reg_admin.php/reg_delegado.php" method="post">
        <h2>Registrar</h2>
        <label for="">Código:</label> 
        <input type="text" name="id_delegado" required>
        <br><br>
        <label for="">Nombre:</label> 
        <input type="text" name="nombre_delegado" required>
        <br><br>
        <label for="">Correo:</label> 
        <input type="text" name="correo_delegado" required>
        <br><br>
        <label for="">Password:</label> 
        <input type="text" name="password_delegado" required>
        <br><br>
        <label for="">Teléfono:</label> 
        <input type="text" name="telefono_delegado" required>
        <br><br>
